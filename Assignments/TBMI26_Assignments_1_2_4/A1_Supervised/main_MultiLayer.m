...
% Add your own code to setup data for training and test here
  ...
  XTest  = combineBins(XBins, [2:20]);
  DTest  = combineBins(DBins, [2:20]);
  LTest  = combineBins(LBins, [2:20]);
...
numIterations = 500000;   % Change this, number of iterations (epochs)
learningRate  = 0.01; % Change this, your learning rate
W0 = randn(numHidden,size(XTrain, 2)); % Initialize your weight matrix W
V0 = randn(length(unique(LTrain)),numHidden+1); % Initialize your weight matrix V
