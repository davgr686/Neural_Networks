...
for n = 1:numIterations
    ...
    grad_v = 2/NTrain * (YTrain - DTrain)' * U; % Gradient for the output layer
    grad_w = 2/NTrain * (((YTrain - DTrain)*Vout(:,1:end-1)).*tanhprim(XTrain * Wout'))' * XTrain;
    % 1332x2 * 1332x7 * 1332x3 * 2x7 = 7x3
